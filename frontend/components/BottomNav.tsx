              ...
              <AnimatePresence>
                {tabBubbles.map((b) => (
                  <motion.span
                    ...
                    className="pointer-events-none absolute right-0 top-0 select-none rounded-full bg-ember-500/90 px-1.5 py-0.5 text-[10px] font-semibold leading-none tracking-normal text-ember-50 shadow-[0_4px_20px_rgba(244,134,90,0.55)] ring-1 ring-ember-200/60"
                  >
                    +1
                  </motion.span>
                ))}
